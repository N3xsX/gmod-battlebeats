        ...
        for i, category in ipairs(categories) do
            ...
            if not IsValid(category.panel) then
                ...
                if category.name == catSound then
                    ...
                    checkbox(nil, panel, contentPanel_2, 240, "#btb.options.snd.dynamic_volume", "battlebeats_dynamic_volume", "#btb.options.snd.dynamic_volume_tip")
                ...
                elseif category.name == catOther then
                    ...
                    checkbox(nil, panel, contentPanel_2, 40, "#btb.options.misc.debug_mode", "battlebeats_debug_mode", "#btb.options.misc.debug_mode_tip")
