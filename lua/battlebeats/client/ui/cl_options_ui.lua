...
local catUser = language.GetPhrase("btb.options.cat.user")
        ...
        for i, category in ipairs(categories) do
            ...
            if not IsValid(category.panel) then
                ...
                if category.name == catSound then
                    ...
                    checkbox(nil, panel, contentPanel:GetWide() / 4, 240, "#btb.options.snd.dynamic_volume", "battlebeats_dynamic_volume", "#btb.options.snd.dynamic_volume_tip")
                    checkbox(nil, panel, contentPanel:GetWide() / 1.4, 240, "#btb.options.snd.dynamic_volume_env", "battlebeats_dynamic_volume_env", "#btb.options.snd.dynamic_volume_env_tip")
                    comboBox(nil, panel, (contentPanel_2 - 100) - 110, 280, "#btb.spawnmenu.general.combo", "battlebeats_disable_mode", { "#btb.spawnmenu.general.combo_1", "#btb.spawnmenu.general.combo_2", "#btb.spawnmenu.general.combo_3" })
                    comboBox(nil, panel, (contentPanel_2 - 100) + 110, 280, "#btb.options.snd.start_mode", "battlebeats_start_mode", { "#btb.options.snd.start_mode_1", "#btb.options.snd.start_mode_2", "#btb.options.snd.start_mode_3", "#btb.options.snd.start_mode_4" }, "#btb.options.snd.start_mode_tip")
                elseif category.name == catNoti then
                    ...
                    arrowStepper(nil, panel, contentPanel_NumSlider, 170, "#btb.options.noti.x_pos", "battlebeats_notif_x", 0, ScrW(), "\n")
                    arrowStepper(nil, panel, contentPanel_NumSlider, 220, "#btb.options.noti.y_pos", "battlebeats_notif_y", 0, ScrH(), "\n")
                ...
                elseif category.name == catOther then
                    ...
                    checkbox(nil, panel, contentPanel:GetWide() / 4, 40, "#btb.options.misc.lower_vol_in_menu", "battlebeats_lower_volume_in_menu", "#btb.options.misc.lower_vol_in_menu_tip")
                    checkbox(nil, panel, contentPanel:GetWide() / 1.4, 40, "#btb.options.misc.lower_vol_on_voice", "battlebeats_lower_volume_on_voice_chat", "#btb.options.misc.lower_vol_on_voice_tip")
                    checkbox(nil, panel, contentPanel_2, 70, "#btb.options.misc.debug_mode", "battlebeats_debug_mode", "#btb.options.misc.debug_mode_tip")
                ...
                elseif category.name == catGeneral then
                    arrowStepper(true, panel, contentPanel_NumSlider, 10, "#btb.spawnmenu.server.trigger_distance", "battlebeats_server_max_distance", 100, 10000, "#btb.spawnmenu.server.trigger_distance_tip")
                elseif category.name == catUser then
                    checkbox(true, panel, contentPanel_2, 10, "#btb.options.server.user.noti", "battlebeats_server_client_allow_notifications", "#btb.options.server.user.noti_tip")
                    checkbox(true, panel, contentPanel_2, 40, "#btb.options.server.user.subtitles", "battlebeats_server_client_allow_subtitles", "#btb.options.server.user.subtitles_tip")
...
concommand.Add("battlebeats_restore_defaults", function()
    ...
    RunConsoleCommand("battlebeats_lower_volume_in_menu", "1")
    ...
    RunConsoleCommand("battlebeats_dynamic_volume", "1")
