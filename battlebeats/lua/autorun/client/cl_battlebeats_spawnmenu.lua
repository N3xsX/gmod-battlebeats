...
hook.Add("PopulateToolMenu", "BattleBeats_Settings", function()
    ...
    spawnmenu.AddToolMenuOption("Utilities", "BattleBeats", "BattleBeatsMMMenu", "Advanced", "", "", function(panel)
        ...
        panel:Help(
        "Wait time defines how long the music player will wait before replacing the previous track with a new one. For example, if the ambient wait time is set to 20, and you enter and end combat in less than 20 seconds, the previously playing track will keep playing")
